<template>
  <nav id="navbar" class="relative z-10 w-full text-neutral-800 bg-gradient-to-b from-black/100 to-transparent">
    <div class="flex flex-col max-w-screen-xl px-8 mx-auto lg:items-center lg:justify-between">
